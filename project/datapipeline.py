...
def main():
    ...
    conn = sqlite3.connect(r'/data/planet_systems.sqlite')
    ...
    conn = sqlite3.connect(r'/data/radial_velocity.sqlite')
    ...
    conn = sqlite3.connect(r'/data/pulsar_timing.sqlite')
    ...
    conn = sqlite3.connect(r'/data/microlensing.sqlite')
    ...
    conn = sqlite3.connect(r'/data/direct_imaging.sqlite')
    ...
    conn = sqlite3.connect(r'/data/transit.sqlite')
