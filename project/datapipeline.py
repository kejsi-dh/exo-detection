...
def main():
    ...
    conn = sqlite3.connect('planet_systems.sqlite')
    ...
    conn = sqlite3.connect('radial_velocity.sqlite')
    ...
    conn = sqlite3.connect('pulsar_timing.sqlite')
    ...
    conn = sqlite3.connect('microlensing.sqlite')
    ...
    conn = sqlite3.connect('direct_imaging.sqlite')
    ...
    conn = sqlite3.connect('transit.sqlite')
