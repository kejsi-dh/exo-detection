...
def main():
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/planet_systems.sqlite')
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/radial_velocity.sqlite')
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/pulsar_timing.sqlite')
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/microlensing.sqlite')
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/direct_imaging.sqlite')
    ...
    conn = sqlite3.connect('/Users/Kejsi/made-template/data/transit.sqlite')
